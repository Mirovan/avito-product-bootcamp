...
```
    ...
    Следовательно, конверсия в покупку - 21%.
```

Если конверсия в покупку остается прежней - 21%, то потенциальная прибыль с учетом ёмкости рынка может составить:
660 млн / 100% * 21% = 138 млн
